...
def tf_c51(I, drones_coverage, folder_name, deployment, packet_update_loss, packet_sample_loss):
    ...
    pickle.dump(eval_py_env.tx_attempt_dest, open(folder_name + "/" + deployment + "/" + str(I) + "U_c51_tx_attempt_BS.pickle", "wb"))
    ...
    pickle.dump(eval_py_env.dest_age, open(folder_name + "/" + deployment + "/" + str(I) + "U_c51_BS_age.pickle", "wb")) 
    pickle.dump(eval_py_env.UAV_age, open(folder_name + "/" + deployment + "/" + str(I) + "U_c51_UAV_age.pickle", "wb"))
    pickle.dump(eval_py_env.age_dist_dest, open(folder_name + "/" + deployment + "/" + str(I) + "U_c51_age_dist_BS.pickle", "wb"))

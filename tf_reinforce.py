...
def tf_reinforce(I, drones_coverage, folder_name, deployment):
    ...
    pickle.dump(eval_py_env.tx_attempt_dest, open(folder_name + "/" + deployment + "/" + str(I) + "U_RL_tx_attempt_BS.pickle", "wb"))
    ...
    pickle.dump(eval_py_env.dest_age, open(folder_name + "/" + deployment + "/" + str(I) + "U_RL_BS_age.pickle", "wb")) # will only print the final ages
    pickle.dump(eval_py_env.UAV_age, open(folder_name + "/" + deployment + "/" + str(I) + "U_RL_UAV_age.pickle", "wb")) # # will only print the final ages
    pickle.dump(eval_py_env.age_dist_dest, open(folder_name + "/" + deployment + "/" + str(I) + "U_RL_age_dist_BS.pickle", "wb"))
